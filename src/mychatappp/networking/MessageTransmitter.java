...
public class MessageTransmitter extends Thread {
    ...
    int targetport, receivePort, key=0, triggerForSendingFile;
    WritableGUI gui;

    public MessageTransmitter(WritableGUI gui,String message, String hostname, int targetport, int receivePort, String user, int trigger) {
        this.gui  = gui ;
